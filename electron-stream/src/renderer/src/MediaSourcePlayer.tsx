...
async function startPlayback({ path, slaveVideo, masterVideo, videoStreamIndex, audioStreamIndexes, seekTo, signal, size, fps, rotate, onCanPlay, onResetNeeded, onWaiting, mediaSourceStreamFactory }: {
  path: string,
  ...
  onResetNeeded: () => void,
  onWaiting: () => void,
  mediaSourceStreamFactory: IMediaSourceStreamFactory,
}) {
  let canPlay = false;
