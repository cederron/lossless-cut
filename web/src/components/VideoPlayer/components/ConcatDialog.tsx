...
import { TOKENS, type FFprobeStream, type FileFfprobeMeta, type IFfmpeg, type IUtils } from 'lossless-cut-application';
import { useInjection } from '../../../di/useInjection';
import { mapRecommendedDefaultFormat } from '../util/mapRecommendedDefaultFormat';
...
function ConcatDialog({ isShown, onHide, paths, mergedFileTemplate, generateMergedFileNames, onConcat, alwaysConcatMultipleFiles, setAlwaysConcatMultipleFiles, fileFormat, setFileFormat, detectedFileFormat, setDetectedFileFormat, onOutputFormatUserChange }: {
  ...
  const outputDir = utils.getOutDir(customOutDir, firstPath);
  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      const fileFormatNew = await utils.getDefaultOutFormat({ filePath: firstPath, fileMeta: firstFileMeta.ffprobeMeta });
