...
import type { FormatTimecode, OverviewWaveform, RenderableWaveform, Thumbnail, WaveformSlice } from './types';
import Button from './components/Button';
import type { UseSegments } from './hooks/useSegments';
import { keyMap } from './hooks/useTimelineScroll';
import type { Frame, InverseCutSegment, StateSegment } from 'lossless-cut-application';
...
function Timeline({
  ...
  const timeFadeTimeoutRef = useRef<NodeJS.Timeout | undefined>(undefined);
