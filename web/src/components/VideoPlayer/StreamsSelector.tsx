...
import { deleteDispositionValue, type CustomTagsByFile, type FilesMeta, type FormatTimecode, type ParamsByStreamId, type StreamParams } from './types';
...
import { TOKENS, type FFprobeChapter, type FFprobeFormat, type FFprobeStream, type FileStream, type IFfmpeg } from 'lossless-cut-application';
...
const Stream = memo(({ filePath, stream, onToggle, toggleCopyStreamIds, copyStream, fileDuration, setEditingStream, onExtractStreamPress, paramsByStreamId, updateStreamParams, formatTimecode, loadSubtitleTrackToSegments }: {
  ...
  const streamFps = ffmpeg.getStreamFps(stream);
